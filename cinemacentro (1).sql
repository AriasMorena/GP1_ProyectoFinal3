...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2025 a las 23:56:28
...
(27, 'Jorge El Curioso', 'Discovery', 'Jorge, El hombre del Sombrero Amarillo', 'Inglaterra', 'Infatil', '2025-11-27', 1),
(28, 'MasterChef', 'Martitegui', 'Donato, Betular', 'Argentino', 'Cocina', '2025-11-20', 1),
(29, 'Los Simpson', 'MattGroening', 'Homero', 'Estados Unidos', 'Comedia', '2025-11-27', 1);
...
--
ALTER TABLE `asiento`
  MODIFY `id_lugar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=692;

--
-- AUTO_INCREMENT de la tabla `pelicula`
--
ALTER TABLE `pelicula`
  MODIFY `id_pelicula` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de la tabla `proyeccion`
--
ALTER TABLE `proyeccion`
  MODIFY `id_proyeccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
ALTER TABLE `ticket_compra`
  ...
  ADD CONSTRAINT `ticket_compra_ibfk_3` FOREIGN KEY (`id_lugar`) REFERENCES `asiento` (`id_lugar`);
COMMIT;
